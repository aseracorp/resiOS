    ...
    <Stack spacing={{xs: 1, sm: 1, md: 2 }}>
      <Stack direction="row" spacing={2}>
        ...
        <DownloadFile
          ...
          label={t('management.servApps.exportDockerBackupButton.exportDockerBackupLabel')}
      ...
      <Grid2 container spacing={{xs: 1, sm: 1, md: 2 }}>
        {updatesAvailable && updatesAvailable.length && <Grid2 style={gridAnim} xs={12} item>
          <Item>
            <Alert severity="info">{t('management.servapps.updatesAvailableFor')} {Object.keys(updatesAvailable).join(', ')}</Alert>
          </Item>
        </Grid2>}
              ...
              <div>
                <Link to={app.type === 'stack' ? 
                  ...
                  <Button variant="outlined" color="primary" fullWidth>
                    {app.type === 'stack' ? t('management.servapps.viewStackButton') : t('management.servapps.viewDetailsButton')}
                  </Button>
                </Link>
              </div>
              {/* <Stack>
