...
export const NetworksColumns = (theme, isDark, t) => [
  {
    title: t('management.servapps.networks.list.networkName'),
  ...
  {
    title: t('management.servapps.networks.list.networkproperties'),
    screenMin: 'md',
    field: (r) => (
  ...
  {
    title: t('management.servapps.networks.list.networkIpam'),
    screenMin: 'lg',
    ...
    )) : t('management.servapps.networks.list.networkNoIp'),
  },
  {
