...
const GetActions = ({
  ...
  let actions = [
    {
      t: t('management.servapps.actionBar.update') + (isStack ? ', go the stack details to update' : ', Click to Update'),
      if: ['update_available'],
    ...
    {
      t: t('management.servapps.actionBar.noUpdate'),
    ...
    {
      t: t('management.servapps.actionBar.start'),
      if: ['exited', 'created'],
    ...
    {
      t: t('management.servapps.actionBar.unpause'),
      if: ['paused'],
    ...
    {
      t: t('management.servapps.actionBar.pause'),
      if: ['running'],
    ...
    {
      t: t('management.servapps.actionBar.stop'),
    ...
    {
      t: t('management.servapps.actionBar.restart'),
    ...
    {
      t: t('management.servapps.actionBar.recreate'),
      if: ['exited', 'running', 'paused', 'created', 'restarting'],
      hideStack: true,
    ...
    {
      t: t('management.servapps.actionBar.kill'),
  ...
  return <>
    {pullRequest && <LogsInModal
      request={pullRequest}
      title={t('management.servapps.actionBar.updating')}
      OnSuccess={() => {
        refreshServApps();
        setPullRequest(null);
      }}
