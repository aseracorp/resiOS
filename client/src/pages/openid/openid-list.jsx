  ...
  return <div style={{}}>
    ...
    {config && <>
      ...
      {newSecret && <Dialog open={newSecret} onClose={() => setNewSecret(false)}>
        <DialogTitle>{t('management.openId.newSecret')}</DialogTitle>
        <DialogContent>
          <DialogContentText>
            {t('management.openId.secretUpdated')}
      ...
      <Alert severity="warning" icon={<WarningOutlined />}>
        {t('management.openId.experimentalWarning')}
      </Alert>
      ...
      {clients && <PrettyTableView
        ...
        columns={[
          ...
          {
            title: t('management.openId.redirectUri'),
            screenMin: 'sm',
            search: (r) => r.redirect,
            field: (r) => r.redirect,
          },
          {
            title: '', clickable: true, field: (r, k) => <>
              ...
              }}>{t('management.openId.resetSecret')}</Button>&nbsp;&nbsp;
